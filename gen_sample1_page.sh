...
printf "%s" "<embed style=\"background: transparent url(../assets/images/spinner.gif) no-repeat center\" type=\"application/pdf\" width=\"800\" height=\"400\" src=\"data:application/pdf;base64," >> sample_1.md
